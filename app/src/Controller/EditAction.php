...
class EditAction extends Base
{
     ...
     * 
     * Handles both GET (read) and PUT (update) requests.
     * GET: Returns the record data for editing or viewing.
     * PUT: Updates the record with provided data.
     * 
    ...
    public function __invoke(array $crudSchema, CRUD6ModelInterface $crudModel, ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        // Check if this is a PUT request (update) or GET request (read)
     ...
     */
    protected function handleUpdate(array $crudSchema, CRUD6ModelInterface $crudModel, ServerRequestInterface $request, ResponseInterface $response, $recordId): ResponseInterface
    {
