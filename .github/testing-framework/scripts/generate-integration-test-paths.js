        ...
        authenticated: {
            api: {
                ...
                create: {
                    ...
                    note: "Requires payload with model-specific fields. HTTP 201 Created or 409 Conflict (if duplicate) is also accepted."
                },
                single: {
                    method: "GET",
                ...
                update: {
                    ...
                    note: "Requires payload with fields to update. HTTP 201 Created or 409 Conflict (if duplicate) is also accepted."
                },
                delete: {
                    method: "DELETE",
                    path: "{api_prefix}/{model}/{test_id}",
