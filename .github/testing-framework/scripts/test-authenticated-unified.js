...
async function testAuthenticatedUnified(configFile, baseUrlOverride, usernameOverride, passwordOverride) {
    ...
    console.log('');
    console.log('ℹ️  Note: Test payloads are pre-generated by seed generation process');
    console.log('   Payloads in test config respect field validation and uniqueness');
    console.log('');
