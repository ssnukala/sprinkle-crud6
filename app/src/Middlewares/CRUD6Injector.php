...
class CRUD6Injector extends AbstractInjector
{
    ...
    protected function getInstance(?string $id): CRUD6ModelInterface
    {
        ...
        $this->debugLog("CRUD6 [CRUD6Injector] Loading schema from SchemaService", [
            'model' => $modelName,
            'connection' => $this->currentConnectionName ?? 'null',
        ]);
        ...
        $this->debugLog("CRUD6 [CRUD6Injector] Schema loaded in getInstance() and CACHED for reuse", [
            'model' => $modelName,
        ...
        $this->debugLog("CRUD6 [CRUD6Injector] Record loaded successfully", [
            'model' => $modelName,
            'id' => $id,
        ]);
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        $this->debugLog("CRUD6 [CRUD6Injector] Calling getInstance()", [
            'model' => $this->currentModelName,
            'id' => $id,
        ]);
        ...
        $this->debugLog("CRUD6 [CRUD6Injector] ✅ REUSING cached schema from getInstance() (avoiding duplicate load)", [
            'model' => $this->currentModelName,
        ]);
        ...
        if ($schema === null) {
            ...
            $this->debugLog("CRUD6 [CRUD6Injector] ⚠️ WARNING: Schema cache was null, falling back to loading", [
                'model' => $this->currentModelName,
            ]);
            $schema = $this->schemaService->getSchema($this->currentModelName, $this->currentConnectionName);
        }

        $this->debugLog("CRUD6 [CRUD6Injector] Schema ready for injection", [
            'model' => $this->currentModelName,
            'table' => $schema['table'] ?? 'unknown',
        ]);
